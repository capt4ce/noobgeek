...
<html>
    ...
    <body>
        ...
        <div class="grey darken-4 white-text" id="quote-div">
            <br><br><blockquote><h5><i>
                This is an example quotation that uses the blockquote tag.
            </i></h5></blockquote><br><br>
        </div>
        
        
        <div class="container" id="content"><br><br>
                <div class="divider"></div>
                <h3>Categories</h3>
                <ul class="collapsible popout" data-collapsible="accordion">
                    <li>
                        <div class="collapsible-header">Electronics</div>
                    ...
                    <li>
                        <div class="collapsible-header">Arduino</div>
                        <div class="collapsible-body"><p>Lorem ipsum dolor sit amet.</p></div>
                    </li>
                    <li>
